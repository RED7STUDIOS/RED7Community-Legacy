...
<div class="page-content-wrapper">
    ...
    <main class="col-md-9">
        ...
        <p>By accessing this Website, accessible from red7community.ml, you are agreeing to be bound by these Website
        ...
        <p>Permission is granted to temporarily download one copy of the materials on RED7 STUDIOS's Website for
        ...
        <p>This will let RED7 STUDIOS to terminate upon violations of any of these restrictions. Upon termination, your
        ...
        <p>All the materials on RED7 STUDIOS’s Website are provided "as is". RED7 STUDIOS makes no warranties, may it be
            expressed or implied, therefore negates all other warranties. Furthermore, RED7 STUDIOS does not make any
        ...
        <p>RED7 STUDIOS or its suppliers will not be hold accountable for any damages that will arise with the use or
            inability to use the materials on RED7 STUDIOS’s Website, even if RED7 STUDIOS or an authorize
        ...
        <p>The materials appearing on RED7 STUDIOS’s Website may include technical, typographical, or photographic
            errors. RED7 STUDIOS will not promise that any of the materials in this Website are accurate, complete, or
            current. RED7 STUDIOS may change the materials contained on its Website at any time without notice. RED7
            STUDIOS does not make any commitment to update the materials.</p>

        <h2>6. Links</h2>

        <p>RED7 STUDIOS has not reviewed all of the sites linked to its Website and is not responsible for the contents
            of any such linked site. The presence of any link does not imply endorsement by RED7 STUDIOS of the site.
            The use of any linked website is at the user’s own risk.</p>

        <h2>7. Site Terms of Use Modifications</h2>

        <p>RED7 STUDIOS may revise these Terms of Use for its Website at any time without prior notice. By using this
        ...
        <p>Any claim related to RED7 STUDIOS's Website shall be governed by the laws of au without regards to its
        ...
        <p>- Sharing accounts is not permitted, you will need separate accounts if you wish to play.</p>
        <p>- No logging in to other people's accounts even with permission from the owner.</p>
        <p>- Don't attempt to find or abuse bugs for non-bug/bounty hunting purposes.</p>
