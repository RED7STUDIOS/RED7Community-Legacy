<?php
    ...
    // *** version number of RED7Community Installer
    ...
    define('EI_CONFIG_FILE_NAME', 'assets/config.php');
    ...
    // -------------------------------------------------------------------------
    // *** application name
    define('EI_APPLICATION_NAME', 'RED7Community');
    // *** version number of your application 
    define('EI_APPLICATION_VERSION', 'v0.1-beta.5');
