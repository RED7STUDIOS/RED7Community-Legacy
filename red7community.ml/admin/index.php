    ...
    <div class="page-content-wrapper">
        ...
        <fieldset>
            <form method="post" action="/ajax/moderate.php" onSubmit="return ajaxSubmit(this);">
                <h5>Site Name:</h5>
                <input maxlength="69420" type="text" name="site_name" class="moderate-input"
                    value="<?php echo htmlspecialchars($site_name); ?>" />
                <h5>Currency:</h5>
                <input maxlength="69420" type="text" name="currency" class="moderate-input"
                    value="<?php echo $currency_name; ?>" />
                <h5>Premium Icon:</h5>
                <input maxlength="69420" type="text" name="premiumIcon" class="moderate-input"
                    value="<?php echo $premiumIcon; ?>" />
                <h5>Verified Icon:</h5>
                <input maxlength="69420" type="text" name="verifiedIcon" class="moderate-input"
                    value="<?php echo $verifiedIcon; ?>" />
                <h5>Appeal Email:</h5>
                <input maxlength="69420" type="text" name="appealEmail" class="moderate-input"
                    value="<?php echo $appealEmail; ?>" />
                <h5>Registration:</h5>
