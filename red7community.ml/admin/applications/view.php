...
<head>
    ...
    <title>Viewing Application: <?php echo $_GET['id']; ?> - <?php echo htmlspecialchars($site_name); ?></title>
...
<body>
    ...
    <div class="page-content-wrapper">
        ...
        <div class="d-flex align-items-center border-bottom" style="display: inline;">
            <h2>Viewing Application: <?php echo $_GET['id']; ?></h2>
        </div>
