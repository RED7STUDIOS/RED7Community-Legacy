...
INSERT INTO `avatars` (`ownerid`, `items`, `shirt`, `pants`, `face`) VALUES
	...
	(5, '[11,10,7,17]', 9, 8, 5),
	(6, '[7,13]', 14, 15, 5),
	(8, '{"1":7,"2":11,"3":17,"4":10}', 14, 15, 5),
	(9, '[]', 0, 0, 5),
	(10, '[]', 9, 8, 5),
	(11, '[7]', 9, 8, 5),
	(12, '{"1":17,"2":7,"3":10,"4":11}', 18, 8, 0),
	(13, '[]', 9, 8, 5),
	(14, '{"1":11,"2":12,"3":10,"4":6,"5":17}', 9, 8, 5),
	(15, '[10,6,17]', 18, 8, 5),
	(16, '[]', 9, 8, 5),
	(17, '[]', 9, 8, 5),
	(18, '[]', 9, 8, 5),
...
INSERT INTO `users` (`id`, `username`, `displayname`, `email`, `password`, `description`, `created_at`, `lastLoginDate`, `lastLogin`, `currency`, `badges`, `items`, `membership`, `isBanned`, `bannedReason`, `bannedDate`, `isAdmin`, `isVerified`, `followers`, `following`, `clans`, `icon`) VALUES
	(1, 'RED7Community', 'RED7Community', NULL, '', '$2y$10$wpjoA7MtKAx01nMxmhCE.Ofj.v5Xb1.dQuq4q89AiSPA5KwxV0Lia', '2021-02-27 22:59:37', '2021-06-10', '2021-06-10 13:48:55', 0, '[1,2,3]', '[1]', 'PremiumDaily2200', 0, NULL, NULL, 1, 1, '[]', '[]', '[]', 'https://www.gravatar.com/avatar/?s=180&d=mp&r=g'),
	(9, 'Not Found', 'Not Found', 'temp@temp.temp', '', 'This account is reserved to make sure that no-one accidentally creates it and gets locked out.', '2021-05-20 21:41:12', NULL, NULL, 0, '[]', '[]', 'None', 1, 'Reserved.', '2021-05-20 21:41:28', 0, 0, '[]', '[]', '[]', 'https://www.gravatar.com/avatar/8f79d54d603c0523c095d7e1e8dd37e5?s=180'),
