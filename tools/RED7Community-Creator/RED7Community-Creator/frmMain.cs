    ...
    public partial class frmMain : Form
    {
        ...
        private void btnGenerate_Click(object sender, EventArgs e)
        {
            ...
            using (StreamWriter writer = File.CreateText(dbFileName))
            {
                ...
                writer.WriteLine("(-3, 'pants1', 'Testing Pants', 'This is test pants.', '2022-04-24 22:34:44', 'None', '[]', -1, 'Pants', 0, 1, NULL, '/Catalog/Pants/Pants.png', NULL, NULL, '/Catalog/Pants/Pants.png', 1),");
                writer.WriteLine("(-2, 'shirt1', 'Testing Shirt', 'This is a test shirt.', '2022-04-24 22:34:44', 'None', '[]', -1, 'Shirt', 0, 1, NULL, '/Catalog/Shirts/Shirt.png', NULL, NULL, '/Catalog/Shirts/Shirt.png', 1),");
                writer.WriteLine("(-1, 'testitem', 'Testing Item', 'A test item for testing out new features on the catalog.', '2022-04-15 23:13:13', 'Premium', '[]', -1, 'Cosmetic', 0, 0, NULL, '/assets/images/testicon-2.png', NULL, NULL, NULL, 1),");
                ...
                writer.WriteLine("(1, 'Roxy-Pin', 'Roxy Pin', 'Show off your true dog kindness!', '2022-04-16 21:04:56', 'None', '[]', -1, 'Cosmetic', 0, 0, NULL, '/assets/images/catalog/roxy-pin.png', '/Catalog/Hats/1b234298.obj', '/Catalog/Hats/1b234298.mtl', NULL, 1),");
                ...
                writer.WriteLine("(3, 'Pesky-Bee', 'Bee', 'This buzzer is very PESKY!', '2022-04-20 12:54:10', 'None', '[]', -1, 'Cosmetic', 0, 0, NULL, '/assets/images/catalog/bee.png', NULL, NULL, NULL, 1),");
                writer.WriteLine("(4, 'Stultus-Aprilis', 'Stultus Aprilis', 'Non te deseram.', '2022-04-20 13:19:25', 'Premium', '[]', -1, 'Cosmetic', 0, 0, NULL, '/assets/images/catalog/stultus-aprilis.png', NULL, NULL, NULL, 1),");
                writer.WriteLine("(5, 'Default-Face', 'Default Face', 'Owners for this item will <b>NOT</b> be set.', '2022-04-24 22:26:07', 'None', '[]', -1, 'Face', 0, 1, NULL, 'https://cdn.jsdelivr.net/gh/RED7Studios/RED7Community-CDN@main/Catalog/Faces/Face.png', NULL, NULL, '/Catalog/Faces/Face.png', 1),");
                writer.WriteLine("(6, 'Gold-Tophat', 'Gold Tophat', 'Bring out your riches with this tophat.', '2022-04-25 17:00:51', 'None', '[]', 500, 'Hat', 0, 1, NULL, 'https://cdn.jsdelivr.net/gh/RED7Studios/RED7Community-CDN@main/Catalog/Hats/Gold-Tophat-Render.png', '/Catalog/Hats/Gold-Tophat.obj', '/Catalog/Hats/Gold-Tophat.mtl', NULL, 1),");
                writer.WriteLine("(7, 'Beta-Tester-Hat', 'Beta Tester Hat', 'This item is only available during the Beta Testing period which was available from 19/04/2022 to sometime in the future.', '2022-04-25 17:00:51', 'None', '[]', 0, 'Hat', 0, 1, 999999, 'https://cdn.jsdelivr.net/gh/RED7Studios/RED7Community-CDN@main/Catalog/Hats/Beta-Tester-Hat-Render.png', '/Catalog/Hats/Beta-Tester-Hat.obj', '/Catalog/Hats/Beta-Tester-Hat.mtl', NULL, 1),");
                writer.WriteLine("(8, 'Black-Pants', 'Black Pants', 'Be stylish with these pants!', '2022-04-24 22:34:44', 'None', '[]', 0, 'Pants', 0, 1, NULL, 'https://cdn.jsdelivr.net/gh/RED7Studios/RED7Community-CDN@main/Catalog/Pants/Black-Pants-Render.png', NULL, '', '/Catalog/Pants/Black-Pants.png', 1),");
                writer.WriteLine("(9, 'Purple-Hoodie', 'Purple Hoodie', 'A free hoodie to get you started!', '2022-04-25 17:00:51', 'None', '[]', 0, 'Shirt', 0, 1, NULL, 'https://cdn.jsdelivr.net/gh/RED7Studios/RED7Community-CDN@main/Catalog/Shirts/Purple-Hoodie-Render.png', '', '', '/Catalog/Shirts/Purple-Hoodie.png', 1),");
                writer.WriteLine("(10, 'Diamond-Encrusted-Sunglasses', 'Diamond Encrusted Sunglasses', 'Show off your richness with these sunglasses.', '2022-04-28 12:18:54', 'None', '[]', 50000, 'Face Accessory', 1, 1, 100, 'https://cdn.jsdelivr.net/gh/RED7Studios/RED7Community-CDN@main/Catalog/Hats/Diamond-Encrusted-Sunglasses-Render.png', '/Catalog/Hats/Diamond-Encrusted-Sunglasses.obj', '/Catalog/Hats/Diamond-Encrusted-Sunglasses.mtl', NULL, 1),");
                writer.WriteLine("(11, 'Star-Pin', 'Star Pin', 'You are really a STAR! | Original by printable_models on Free3D', '2022-04-28 13:21:43', 'None', '[]', 50, 'Front', 0, 1, NULL, 'https://cdn.jsdelivr.net/gh/RED7Studios/RED7Community-CDN@main/Catalog/Hats/Star-Pin-Render.png', '/Catalog/Hats/Star-Pin.obj', '/Catalog/Hats/Star-Pin.mtl', NULL, 1),");
                writer.WriteLine("(12, 'Crown', 'Crown', 'You are honored! | Original by printable_models on Free3D', '2022-04-28 13:48:43', 'None', '[]', 50, 'Hat', 0, 1, NULL, 'https://cdn.jsdelivr.net/gh/RED7Studios/RED7Community-CDN@main/Catalog/Hats/Crown-Render.png', '/Catalog/Hats/Crown.obj', '/Catalog/Hats/Crown.mtl', NULL, 1),");
                ...
                writer.WriteLine("(14, 'Matrix-Shirt', 'Matrix Shirt', 'This item is only available from the first Hackvent.', '2022-04-25 17:00:51', 'None', '[]', -1, 'Shirt', 0, 1, NULL, 'https://cdn.jsdelivr.net/gh/RED7Studios/RED7Community-CDN@main/Catalog/Shirts/Matrix-Shirt-Render.png', '', '', '/Catalog/Shirts/Matrix-Shirt.png', 1),");
                writer.WriteLine("(15, 'Matrix-Pants', 'Matrix Pants', 'This item is only available from the first Hackvent.', '2022-04-25 17:00:51', 'None', '[]', -1, 'Pants', 0, 1, NULL, 'https://cdn.jsdelivr.net/gh/RED7Studios/RED7Community-CDN@main/Catalog/Shirts/Matrix-Shirt-Render.png', '', '', '/Catalog/Shirts/Matrix-Shirt.png', 1),");
                ...
                writer.WriteLine("(17, 'Ban-Hammer', 'Ban Hammer', 'This hammer is only given out to those who are trusted.', '2022-05-03 06:56:00', 'None', '[]', -1, 'Gear', 0, 1, 0, 'https://cdn.jsdelivr.net/gh/RED7Studios/RED7Community-CDN@main/Catalog/Gear/Ban-Hammer-Render.png', '/Catalog/Gear/Ban-Hammer.obj', '/Catalog/Gear/Ban-Hammer.mtl', NULL, 1),");
                writer.WriteLine("(18, 'Mitchells-Shirt', 'Black Hoodie', 'Thats stealthy!', '2022-04-25 17:00:51', 'None', '[]', 5, 'Shirt', 0, 1, NULL, 'https://cdn.jsdelivr.net/gh/RED7Studios/RED7Community-CDN@main/Catalog/Shirts/Mitchells-Shirt-Render.png', '', '', '/Catalog/Shirts/Mitchells-Shirt.png', 1),");
                writer.WriteLine("(19, 'Mitchells-Hat', 'Mitchells Hat', 'Exclusive item to Mitchells account.', '2022-04-25 17:00:51', 'None', '[]', -1, 'Hat', 0, 1, 999999, 'https://cdn.jsdelivr.net/gh/RED7Studios/RED7Community-CDN@main/Catalog/Hats/Mitchells-Hat-Render.png', '/Catalog/Hats/Beta-Tester-Hat.obj', '/Catalog/Hats/Mitchells-Hat.mtl', NULL, 1),");
                writer.WriteLine("(20, 'Toilet', 'Toilet', 'Son, how did you get that on your head?', '2022-04-28 13:48:43', 'None', '[]', 500, 'Hat', 0, 1, NULL, 'https://cdn.jsdelivr.net/gh/RED7Studios/RED7Community-CDN@main/Catalog/Hats/Toilet-Render.png', '/Catalog/Hats/Toilet.obj', '/Catalog/Hats/Toilet.mtl', NULL, 1),");
                writer.WriteLine("(21, 'TAA-Shirt', 'TAA Shirt', 'Exclusive item to Mitchells account.', '2022-06-06 00:00:51', 'None', '[]', -1, 'Shirt', 0, 1, NULL, 'https://cdn.jsdelivr.net/gh/RED7Studios/RED7Community-CDN@main/Catalog/Shirts/Mitchells-Shirt-Render.png', '', '', '/Catalog/Shirts/TAA-Shirt.png', 1),");
                writer.WriteLine("(22, 'White-Hat', 'White Hat of Goodness', 'This hat can only be obtained through the Bug Hunting Program.', '2022-06-06 01:00:51', 'None', '[]', -1, 'Hat', 0, 1, 999999, 'https://cdn.jsdelivr.net/gh/RED7Studios/RED7Community-CDN@main/Catalog/Hats/White-Hat-Render.png', '/Catalog/Hats/Beta-Tester-Hat.obj', '/Catalog/Hats/White-Hat.mtl', NULL, 1),");
                writer.WriteLine("(23, 'Dominus-Hood', 'Dominus Hood', 'Less expensive dominus hood', '2022-06-06 01:00:51', 'None', '[]', -1, 'Hat', 0, 1, 999999, 'https://cdn.jsdelivr.net/gh/RED7Studios/RED7Community-CDN@main/Catalog/Hats/Dominus-Hood-Render.png', '/Catalog/Hats/Dominus-Hood.obj', '/Catalog/Hats/Dominus-Hood.mtl', NULL, 9);");
                writer.WriteLine("");
