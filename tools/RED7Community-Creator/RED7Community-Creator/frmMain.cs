    ...
    public partial class frmMain : Form
    {
        ...
        private void btnGenerate_Click(object sender, EventArgs e)
        {
            ...
            using (StreamWriter writer = File.CreateText(dbFileName))
            {
                ...
                writer.WriteLine("(1, 'Administrator', 'Administrator', 'The official admin badge.', 'https://cdn.jsdelivr.net/gh/RED7Studios/RED7Community-CDN@main/Shop/Badges/administrator.png'),");
                writer.WriteLine("(2, 'Welcome', 'Welcome', 'The official welcome badge.', 'https://cdn.jsdelivr.net/gh/RED7Studios/RED7Community-CDN@main/Shop/Badges/welcome.png'),");
                writer.WriteLine("(3, 'Beta-Tester', 'Beta Tester', 'The official beta testing badge.', 'https://cdn.jsdelivr.net/gh/RED7Studios/RED7Community-CDN@main/Shop/Badges/beta-tester.png'),");
                writer.WriteLine("(4, 'Bug-Hunter', 'Bug Hunter', 'People with this badge are immune to being banned for finding bugs, however a warning or 3 day ban can still occur if a bug is not reported.', 'https://cdn.jsdelivr.net/gh/RED7Studios/RED7Community-CDN@main/Shop/Badges/bug-hunter.png');");
                writer.WriteLine("");
                writer.WriteLine("CREATE TABLE IF NOT EXISTS `items` (");
                writer.WriteLine("`id` bigint NOT NULL DEFAULT '0',");
                ...
                writer.WriteLine(") ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;");
                writer.WriteLine("");
                writer.WriteLine("INSERT INTO `items` (`id`, `name`, `displayname`, `description`, `created`, `membershipRequired`, `owners`, `price`, `type`, `isLimited`, `isEquippable`, `copies`, `icon`, `obj`, `mtl`, `texture`, `creator`) VALUES");
                writer.WriteLine("(-3, 'pants1', 'Testing Pants', 'This is test pants.', '2022-04-24 22:34:44', 'None', '[]', -1, 'Pants', 0, 1, NULL, '/Shop/Pants/Pants.png', NULL, NULL, '/Shop/Pants/Pants.png', 1),");
                writer.WriteLine("(-2, 'shirt1', 'Testing Shirt', 'This is a test shirt.', '2022-04-24 22:34:44', 'None', '[]', -1, 'Shirt', 0, 1, NULL, '/Shop/Shirts/Shirt.png', NULL, NULL, '/Shop/Shirts/Shirt.png', 1),");
                writer.WriteLine("(-1, 'testitem', 'Testing Item', 'A test item for testing out new features on the items.', '2022-04-15 23:13:13', 'Premium', '[]', -1, 'Cosmetic', 0, 0, NULL, '/assets/images/testicon-2.png', NULL, NULL, NULL, 1),");
                writer.WriteLine("(0, 'masonissupercool', 'mapleson', 'only mason idiots', '2022-06-10 13:44:35', 'Premium', '[]', -1, 'Face', 1, 1, NULL, 'https://i.imgur.com/oODFyP6.png', NULL, NULL, 'https://i.imgur.com/oODFyP6.png', 1),");
                writer.WriteLine("(1, 'Roxy-Pin', 'Roxy Pin', 'Show off your true dog kindness!', '2022-04-16 21:04:56', 'None', '[]', -1, 'Cosmetic', 0, 0, NULL, '/assets/images/shop/roxy-pin.png', '/Shop/Hats/1b234298.obj', '/Shop/Hats/1b234298.mtl', NULL, 1),");
                writer.WriteLine("(2, 'Beta-Tester-Ribbon', 'Beta Tester Ribbon', 'This item is only available during the Beta Testing period which was available from 19/04/2022 to sometime in the future.', '2022-04-19 21:00:36', 'None', '[]', 0, 'Cosmetic', 0, 0, NULL, '/assets/images/shop/beta-tester-ribbon.png', '/Shop/Hats/1d653684.obj', '/Shop/Hats/1d653684.mtl', NULL, 1),");
                writer.WriteLine("(3, 'Pesky-Bee', 'Bee', 'This buzzer is very PESKY!', '2022-04-20 12:54:10', 'None', '[]', -1, 'Cosmetic', 0, 0, NULL, '/assets/images/shop/bee.png', NULL, NULL, NULL, 1),");
                writer.WriteLine("(4, 'Stultus-Aprilis', 'Stultus Aprilis', 'Non te deseram.', '2022-04-20 13:19:25', 'Premium', '[]', -1, 'Cosmetic', 0, 0, NULL, '/assets/images/shop/stultus-aprilis.png', NULL, NULL, NULL, 1),");
                writer.WriteLine("(5, 'Default-Face', 'Default Face', 'Owners for this item will <b>NOT</b> be set.', '2022-04-24 22:26:07', 'None', '[]', -1, 'Face', 0, 1, NULL, 'https://cdn.jsdelivr.net/gh/RED7Studios/RED7Community-CDN@main/Shop/Faces/Face.png', NULL, NULL, '/Shop/Faces/Face.png', 1),");
                writer.WriteLine("(6, 'Gold-Tophat', 'Gold Tophat', 'Bring out your riches with this tophat.', '2022-04-25 17:00:51', 'None', '[]', 500, 'Hat', 0, 1, NULL, 'https://cdn.jsdelivr.net/gh/RED7Studios/RED7Community-CDN@main/Shop/Hats/Gold-Tophat-Render.png', '/Shop/Hats/Gold-Tophat.obj', '/Shop/Hats/Gold-Tophat.mtl', NULL, 1),");
                writer.WriteLine("(7, 'Beta-Tester-Hat', 'Beta Tester Hat', 'This item is only available during the Beta Testing period which was available from 19/04/2022 to sometime in the future.', '2022-04-25 17:00:51', 'None', '[]', 0, 'Hat', 0, 1, 999999, 'https://cdn.jsdelivr.net/gh/RED7Studios/RED7Community-CDN@main/Shop/Hats/Beta-Tester-Hat-Render.png', '/Shop/Hats/Beta-Tester-Hat.obj', '/Shop/Hats/Beta-Tester-Hat.mtl', NULL, 1),");
                writer.WriteLine("(8, 'Black-Pants', 'Black Pants', 'Be stylish with these pants!', '2022-04-24 22:34:44', 'None', '[]', 0, 'Pants', 0, 1, NULL, 'https://cdn.jsdelivr.net/gh/RED7Studios/RED7Community-CDN@main/Shop/Pants/Black-Pants-Render.png', NULL, '', '/Shop/Pants/Black-Pants.png', 1),");
                writer.WriteLine("(9, 'Purple-Hoodie', 'Purple Hoodie', 'A free hoodie to get you started!', '2022-04-25 17:00:51', 'None', '[]', 0, 'Shirt', 0, 1, NULL, 'https://cdn.jsdelivr.net/gh/RED7Studios/RED7Community-CDN@main/Shop/Shirts/Purple-Hoodie-Render.png', '', '', '/Shop/Shirts/Purple-Hoodie.png', 1),");
                writer.WriteLine("(10, 'Diamond-Encrusted-Sunglasses', 'Diamond Encrusted Sunglasses', 'Show off your richness with these sunglasses.', '2022-04-28 12:18:54', 'None', '[]', 50000, 'Face Accessory', 1, 1, 100, 'https://cdn.jsdelivr.net/gh/RED7Studios/RED7Community-CDN@main/Shop/Hats/Diamond-Encrusted-Sunglasses-Render.png', '/Shop/Hats/Diamond-Encrusted-Sunglasses.obj', '/Shop/Hats/Diamond-Encrusted-Sunglasses.mtl', NULL, 1),");
                writer.WriteLine("(11, 'Star-Pin', 'Star Pin', 'You are really a STAR! | Original by printable_models on Free3D', '2022-04-28 13:21:43', 'None', '[]', 50, 'Front', 0, 1, NULL, 'https://cdn.jsdelivr.net/gh/RED7Studios/RED7Community-CDN@main/Shop/Hats/Star-Pin-Render.png', '/Shop/Hats/Star-Pin.obj', '/Shop/Hats/Star-Pin.mtl', NULL, 1),");
                writer.WriteLine("(12, 'Crown', 'Crown', 'You are honored! | Original by printable_models on Free3D', '2022-04-28 13:48:43', 'None', '[]', 50, 'Hat', 0, 1, NULL, 'https://cdn.jsdelivr.net/gh/RED7Studios/RED7Community-CDN@main/Shop/Hats/Crown-Render.png', '/Shop/Hats/Crown.obj', '/Shop/Hats/Crown.mtl', NULL, 1),");
                writer.WriteLine("(13, 'Hackvent-1-Hat', 'Hackvent #1 Hat', 'This item is only available from the first Hackvent. Redeem this code to get something special! M@tr1x1', '2022-04-29 14:58:04', 'None', '[1,6]', -1, 'Hat', 0, 1, NULL, 'https://cdn.jsdelivr.net/gh/RED7Studios/RED7Community-CDN@main/Shop/Hats/Hackvent-1-Hat-Render.png', '/Shop/Hats/Beta-Tester-Hat.obj', '/Shop/Hats/Hackvent-1-Hat.mtl', NULL, 1),");
                writer.WriteLine("(14, 'Matrix-Shirt', 'Matrix Shirt', 'This item is only available from the first Hackvent.', '2022-04-25 17:00:51', 'None', '[]', -1, 'Shirt', 0, 1, NULL, 'https://cdn.jsdelivr.net/gh/RED7Studios/RED7Community-CDN@main/Shop/Shirts/Matrix-Shirt-Render.png', '', '', '/Shop/Shirts/Matrix-Shirt.png', 1),");
                writer.WriteLine("(15, 'Matrix-Pants', 'Matrix Pants', 'This item is only available from the first Hackvent.', '2022-04-25 17:00:51', 'None', '[]', -1, 'Pants', 0, 1, NULL, 'https://cdn.jsdelivr.net/gh/RED7Studios/RED7Community-CDN@main/Shop/Shirts/Matrix-Shirt-Render.png', '', '', '/Shop/Shirts/Matrix-Shirt.png', 1),");
                writer.WriteLine("(16, 'M@tr1x1', 'M@tr1x1', 'Look at the Hackvent #1 Cap, challenger.', '2022-05-01 12:48:08', 'None', '[]', -1, 'Hat', 1, 1, 1, NULL, NULL, NULL, NULL, 1),");
                writer.WriteLine("(17, 'Ban-Hammer', 'Ban Hammer', 'This hammer is only given out to those who are trusted.', '2022-05-03 06:56:00', 'None', '[]', -1, 'Gear', 0, 1, 0, 'https://cdn.jsdelivr.net/gh/RED7Studios/RED7Community-CDN@main/Shop/Gear/Ban-Hammer-Render.png', '/Shop/Gear/Ban-Hammer.obj', '/Shop/Gear/Ban-Hammer.mtl', NULL, 1),");
                writer.WriteLine("(18, 'Mitchells-Shirt', 'Black Hoodie', 'Thats stealthy!', '2022-04-25 17:00:51', 'None', '[]', 5, 'Shirt', 0, 1, NULL, 'https://cdn.jsdelivr.net/gh/RED7Studios/RED7Community-CDN@main/Shop/Shirts/Mitchells-Shirt-Render.png', '', '', '/Shop/Shirts/Mitchells-Shirt.png', 1),");
                writer.WriteLine("(19, 'Mitchells-Hat', 'Mitchells Hat', 'Exclusive item to Mitchells account.', '2022-04-25 17:00:51', 'None', '[]', -1, 'Hat', 0, 1, 999999, 'https://cdn.jsdelivr.net/gh/RED7Studios/RED7Community-CDN@main/Shop/Hats/Mitchells-Hat-Render.png', '/Shop/Hats/Beta-Tester-Hat.obj', '/Shop/Hats/Mitchells-Hat.mtl', NULL, 1),");
                writer.WriteLine("(20, 'Toilet', 'Toilet', 'Son, how did you get that on your head?', '2022-04-28 13:48:43', 'None', '[]', 500, 'Hat', 0, 1, NULL, 'https://cdn.jsdelivr.net/gh/RED7Studios/RED7Community-CDN@main/Shop/Hats/Toilet-Render.png', '/Shop/Hats/Toilet.obj', '/Shop/Hats/Toilet.mtl', NULL, 1),");
                writer.WriteLine("(21, 'TAA-Shirt', 'TAA Shirt', 'Exclusive item to Mitchells account.', '2022-06-06 00:00:51', 'None', '[]', -1, 'Shirt', 0, 1, NULL, 'https://cdn.jsdelivr.net/gh/RED7Studios/RED7Community-CDN@main/Shop/Shirts/Mitchells-Shirt-Render.png', '', '', '/Shop/Shirts/TAA-Shirt.png', 1),");
                writer.WriteLine("(22, 'White-Hat', 'White Hat of Goodness', 'This hat can only be obtained through the Bug Hunting Program.', '2022-06-06 01:00:51', 'None', '[]', -1, 'Hat', 0, 1, 999999, 'https://cdn.jsdelivr.net/gh/RED7Studios/RED7Community-CDN@main/Shop/Hats/White-Hat-Render.png', '/Shop/Hats/Beta-Tester-Hat.obj', '/Shop/Hats/White-Hat.mtl', NULL, 1),");
                writer.WriteLine("(23, 'Dominus-Hood', 'Dominus Hood', 'Less expensive dominus hood', '2022-06-06 01:00:51', 'None', '[]', -1, 'Hat', 0, 1, 999999, 'https://cdn.jsdelivr.net/gh/RED7Studios/RED7Community-CDN@main/Shop/Hats/Dominus-Hood-Render.png', '/Shop/Hats/Dominus-Hood.obj', '/Shop/Hats/Dominus-Hood.mtl', NULL, 9);");
                writer.WriteLine("");
