...
<html lang="en">
	<head>
		...
		<title>Catalog - <?php echo $site_name; ?></title>
	...
	<body>
		...
		<div class="page-content-wrapper">
					...
					<a class="btn btn-danger" onclick="showOffsaleItems()"><?php if ( !isset($_GET["offsale"]) ) { echo 'Show'; } else { echo 'Hide'; } ?> Offsale Items</a>
						...
						<?php
							if ($tab == "all")
							{
								...
								while($row = mysqli_fetch_assoc($result)) {
									...
									{
										$item_owned = ' <img src="'. $STORAGE_URL. '/assets/images/item-owned.png" style="height: 20px; width: 20px;"/></h2>';
									}
									else
									{
										$item_owned = "";
