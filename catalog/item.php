...
if (!str_contains($data, "This item doesn't exist or has been deleted"))
{
	...
	$data_u = file_get_contents($API_URL. '/user.php?key='. $API_KEY. '&api=getbyid&id='. $creator);
		...
		<div class="page-content-wrapper">
				<main class="col-md-9">
					<div class="d-flex align-items-center border-bottom">
						...
						&nbsp;
						<div class="wrapper">
							<h2><?php echo $name ?> <?php if (in_array($_GET['id'], $items)) { echo '<img src="'. $STORAGE_URL. '/assets/images/item-owned.png" style="height: 20px; width: 20px;"/></h2>'; } ?>
							<span>
					...
					<div>
						...
						if ($price == "-1")
						{
							echo '<p>This item is currently not for sale.</p>';
						}
						else
						{
							echo '<a href="buy.php?id='. $_GET["id"]. '" class="btn btn-primary">Buy</a>';
						}
						?>
