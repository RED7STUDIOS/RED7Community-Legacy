...
/*
  ...
  Original Location: /users/friends.php
  Description: The list of friends for a user.
...
<html lang="en">
	<head>
		...
		<meta name="description" content="The friends page for <?php echo $username ?>.">
							...
							<?php
								...
								if ($friends != "" && $friends != "[]" && !empty($friends)) {
									foreach ($users as $id=>$name) {
										...
										{
											$data = file_get_contents($API_URL. '/user.php?key='. $API_KEY. '&api=getbyname&name='. $name);
