...
$your_data = file_get_contents($API_URL. '/user.php?key='. $API_KEY. '&api=getbyid&id='. $_SESSION['id']);
...
{
	$data = file_get_contents($API_URL. '/user.php?key='. $API_KEY. '&api=getbyname&name='. $_POST["giftUser"]);
