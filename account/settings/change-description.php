<?php
/*
  File Name: change-description.php
  Original Location: /account/settings/change-description.php
  Description: Changing Description file.
...
<html lang="en">
	<head>
		...
		<title>Change Description - <?php echo $site_name; ?></title>
	...
	<body>
		...
		<div class="page-content-wrapper">
				...
				?>
				<main class="col-md-9">
					<h2>Changing Your Description</h2>
					<?php
						$sql = "UPDATE users SET description = '". $_GET["description"] . "' WHERE id = '". $your_id . "'";
