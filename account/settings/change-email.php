<?php
/*
  File Name: change-email.php
  Original Location: /account/settings/change-email.php
  Description: Changing Email file.
...
<html lang="en">
	<head>
		...
		<title>Change Email - <?php echo $site_name; ?></title>
	...
	<body>
		...
		<div class="page-content-wrapper">
				...
				<main class="col-md-9">
					<h2>Change Email</h2>
					<?php
						$sql = "UPDATE users SET email = '". $_GET["email"] . "' WHERE id = '". $your_id . "'";
